...
class FetchStock:
    def __init__(self, symbol, start_date, end_date, fetcher: StockFetcher):
        self.symbol = symbol
    ...
    def prepare_data(self, data):
        ...
        self.outstanding_shares = self.get_market_cap(self.prepared_data)
    ...
    def fetch_data(self):
        ...
        # return self.fetcher.fetch_stock(self.symbol, self.start_date, self.end_date)
    ...
    def get_market_cap(self, series):
        return self.fetcher.get_market_cap(series)
    ...
    def simulate(self):
        ...
        for date, row in self.data.iterrows():
            ...
            if current_position is None:  # Keine Position
                ...
                profit = (
                    close_price - current_position["entry_price"]
    ...
    def plot_results(self):
        ...
        trades_df = pd.DataFrame(
            [
                {"date": trade["sell"]["date"], "profit": trade["profit"]}
